...
$stmt = $dbh->prepare("INSERT INTO $participantTable (firstName, lastName, address, aptNum, city, state, zipCode, homePhone, otherPhone, emailAddress, allergiesAndMedicalInfo, emergencyContactName, emergencyContactPhone, emergencyContactRelationship, primaryPickupName, primaryPickupRelationship, homeChurch, dateOfBirth, gradeJustCompleted, tShirtSize, signupTime)
					VALUES (:firstName, :lastName, :address, :aptNum, :city, :state, :zipCode, :homePhone, :otherPhone, :emailAddress, :allergiesAndMedicalInfo, :emergencyContactName, :emergencyContactPhone, :emergencyContactRelationship, :primaryPickupName, :primaryPickupRelationship, :homeChurch, :dateOfBirth, :gradeJustCompleted, :tShirtSize, :signupTime)");
$stmt->bindParam(':firstName', $firstName);
$stmt->bindParam(':lastName', $lastName);
